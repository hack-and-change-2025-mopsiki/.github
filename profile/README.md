...
Идея родилась из реальной боли контент-менеджеров: не всегда понятно, что вызывает интерес, а что нет. Мы решили дать им инструмент, который делает это очевидным.
...
✔️ автоматический сбор показателей постов с Хабра, VC, Telegram
✔️ метрики просмотров, дочитываний, лайков, дизлайков, избранного
✔️ анализ комментариев и их тональности (RuBERT)
✔️ дашборды для выявления лучших/худших постов
✔️ чатбота для выгрузки аналитики по промптам на естественном языке
